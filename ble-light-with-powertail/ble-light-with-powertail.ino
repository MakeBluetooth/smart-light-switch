...
// The PowerSwitch Tail needs to be pulled LOW to turn the mains powered device on, this code
// is identical to our LED example but with opposite logic for pin 3.
